		...
		<section class="section">
			<div class="d-flex flex-wrap align-items-stretch">
				...
				<div
					...
					data-background="../assets/img/logo-smp.jpg">
					<div class="absolute-bottom-left index-2">
						<div class="text-light p-5 pb-2">
							<div class="mb-5 pb-3">
								<h1 class="mb-2 display-4 font-weight-bold" style="color: white;"">SMP Pius Bakti Utama Kebumen</h1>
								{{-- <h5 class="font-weight-normal text-muted-transparent">Kebumen</h5> --}}
							</div>
